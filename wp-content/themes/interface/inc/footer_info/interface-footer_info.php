...
/**
 * To display a link to oferplay.com.
 *
 * @return string
 */
function interface_oferplay_link() {
   return '<a href="'.esc_url( 'http://www.oferplay.com' ).'" target="_blank" title="Oferplay" ><span>OFERPLAY</span></a>';
}
?>
